...
void CConfig::SetConfig_Options(unsigned short val_iZone, unsigned short val_nZone) {
 ...
 /* DESCRIPTION:  */
  ...
  /* DESCRIPTION:  */
  addDoubleOption("ACCRETION_INDICATOR", Ac, 0.25);
  /* DESCRIPTION:  */
  addDoubleOption("STAGNATION_FREEZING_FRACTION", n0, 0.2);
  /* DESCRIPTION:  b pour cubique*/
  addDoubleOption("ROUGHNESS_LIMIT", Roughness_Limit, 0.1);
  /* DESCRIPTION:  a pour cubique*/
  addDoubleOption("SMOOTH_WIDTH", Smooth_Width, 0.01);
  /* DESCRIPTION:  */
  addDoubleOption("ROUGHNESS_RATIO", ks_k_ratio, 1.0);
  /* DESCRIPTION:  */
  addDoubleOption("ROUGHNESS_MIN", k_min, 0.0);
  /* DESCRIPTION: Use variable roughness */
  addBoolOption("VARIABLE_ROUGHNESS", Variable_Roughness, false);
  /* DESCRIPTION:  */
