...
private:
  ...
  *Coord_p1;                          /*!< \brief Coordinates at time n+1 for use with dynamic meshes. */
  ...
  su2double Rough,                    /*!< \brief Equivalent sand grain value of the nearest no-slip wall rugosity. */
	Roughness_Height;										/*!< \brief Roughness height value of the nearest rough no-slip wall. */
public:
  ...
  /*!
	...
	/*!
	 * \brief Get roughness height of the nearest no-slip wall point.
	 * \return local roughness height.
	 */
  ...
  /*!
	...
	/*!
	 * \brief Set Roughness height
	 * \param[in] val_roughness_height.
	 */
	void SetRoughness_Height(su2double val_roughness_height);
