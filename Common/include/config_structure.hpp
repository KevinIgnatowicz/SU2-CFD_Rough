...
private:
  ...
  *HTP_Axis,      /*!< \brief Location of the HTP axis. */
  ...
  Variable_Roughness;  /*!< \brief Use variable surface roughness. */
  ...
  *Velocity_FreeStream,     /*!< \brief Total velocity of the fluid.  */
  ...
  Ac, /* !< \brief Ice accretion accumulation indicator */
  n0, /* !< \brief freezing fraction at the leading edge */
  Roughness_Limit, /* !< \brief curvilinear distance between stagnation point and roughness limit. */
  Smooth_Width,    /* !< \brief curvilinear distance between stagnation point and the end of the smooth zone.*/
  ks_k_ratio, /* !< \brief ratio between equivalent sand grain roughness anf roughness height. */
  k_min,      /* !< \brief minimum roughness height. */
...
public:
 ...
 /*!
  ...
  /*!
    * \brief Get the value of the accumulation parameter for variable roughness.
    * \return accumulation parameter.
    */
   su2double GetAccumulation_Parameter(void);

  /*!
    * \brief Get the value of the stagnation freezing fraction.
    * \return stagnation freezing fraction.
    */
   su2double GetFreezing_Fraction(void);

  /*!
    * \brief Get the value of the roughness limit distance.
    * \return roughness limit.
    */
   su2double GetRoughness_Limit(void);

  /*!
    * \brief Get the value of the smooth zone width.
    * \return smooth zone width.
    */
   su2double GetSmooth_Width(void);

 /*!
  * \brief Get the value of minimum roughness height.
  * \return minimum roughness height.
  */
 su2double GetRoughness_Min(void);

  /*!
    * \brief Get the value of the roughness ratio.
    * \return roughness ratio.
    */
   su2double GetRoughness_Ratio(void);

  /*!
    * \brief Get the use of variable roughness.
    * \return if variable roughness is used.
    */
   bool GetVariable_Roughness(void);
