...
inline su2double CPoint::GetRoughness_Height(void) { return Roughness_Height; }
...
inline void CPoint:: SetRoughness_Height(su2double val_roughness_height) { Roughness_Height = val_roughness_height; }
